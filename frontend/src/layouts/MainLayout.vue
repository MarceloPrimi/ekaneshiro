  ...
  <div class="min-h-screen flex bg-gray-50">
    ...
    >
      ...
      <div class="flex items-center justify-between px-3 py-4 border-b border-gray-200 flex-shrink-0 h-14">
        <div v-if="drawerOpen" class="flex items-center gap-2 overflow-hidden">
          <span class="text-base font-semibold tracking-wide text-gray-900 whitespace-nowrap">Sanshin</span>
        </div>
        <button
      ...
      <!-- Footer: email + logout + dark mode -->
      <div class="px-2 py-3 border-t border-gray-200 flex-shrink-0">
        <p v-if="drawerOpen" class="text-xs text-gray-400 truncate px-1 mb-2">{{ auth.user?.email }}</p>
