...
from schemas.usuarios import TokenResponse, UsuarioCreate, UsuarioResponse, UsuarioUpdate
...
def login(
    ...
    token = create_access_token({"sub": usuario.email, "role": usuario.role.value})
